...
const device = {
        ...
        fromZigbee: [
            fz_local.battery_config,
            fz_local.temperature_config,
            fz_local.humidity_config,
            fz_local.illuminance,
            fz_local.illuminance_config,
            fz_local.pressure_config,
            fz.battery,
            fz_local.contact,
            fz_local.occupancy,
            fz_local.occupancy_config,
        ],
        toZigbee: [
            tz_local.occupancy_timeout,
            tz_local.unoccupancy_timeout,
            tz_local.illuminance_config,
            tz_local.change_period,
            tz.factory_reset,
        ],
        meta: {
            configureKey: 1,
